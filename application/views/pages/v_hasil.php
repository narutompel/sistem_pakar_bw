    ...
    <header>
      ...
      <div class="container">
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              <h1><a href="<?php echo base_url('a_beranda')?>"><i class="icon-user"></i> Hasil</a></h1>
            </div>
          </div>
          <div class="span">
...
<!-- section intro -->
    ...
    <div class="panel-body">
      <?php
      if(empty($data_ps)){
      echo "Penyakit yang anda pilih tidak sesuai"
      ...
      ?>
      <p>Kemungkinan sapi Anda mengidap penyakit <b><?php echo $row->nama_penyakit;?></b> </p>
      <?php 
      }
      ?>
        ...
        $poin=$poin+$row->poin_gejala/50*100;
        ?>
        <tr class="success">
        <td><?php echo $no++; ?></td>
    ...
    <br><br><a href="<?php echo site_url('konsultasi') ?>" class="btn btn-success">
