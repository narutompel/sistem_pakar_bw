  ...
  <div id="wrapper">
    ...
    <header>
      ...
      <div class="container">
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              <h1><a href="<?php echo base_url('beranda')?>"><i class="icon-user"></i> Backward Chaining</a></h1>
            </div>
          </div>
          <div class="span8">
    ...
    <section id="intro">
      <div class="intro-content">
		...
		<button class="btn-warning"><a href="<?php echo base_url('konsultasi')?>">Mulai Konsultasi</a></button>
      </div>
    </section>
    <!-- /section intro -->
