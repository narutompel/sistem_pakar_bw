...
<body>
  <div id="wrapper">
    ...
    <header>
      ...
      <div class="container">
        <div class="row nomargin">
          <div class="span4">
            <div class="logo">
              <h1><a href="<?php echo base_url('beranda')?>"><i class="icon-beaker"></i> Backward Chaining</a></h1>
            </div>
          </div>
          <div class="span8">
    ...
    <h3>di Website Sistem Pakar Diagnosa Penyakit Sapi</h3>
    <button class="btn btn-success"><a href="<?php echo base_url('konsultasi')?>">Mulai Konsultasi</a></button>
      </div>
    </section>
    <!-- /section intro -->
